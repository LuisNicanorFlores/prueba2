function palindromo(cadena) {
  ...
  document.getElementById("e").innerHTML="La ruta nos aporto otro paso natural"
  document.getElementById("u").innerHTML="Esta frase no se parece a ningun palindromo"